...
//        tabi.setPreferredSize(new Dimension(100, 100));
	...
	jSPinput.setWheelScrollingEnabled(true);
        ...
        vistaLaterale.setPreferredSize(new Dimension(300, 100));
        ...
        spPaneSup.setPreferredSize(new Dimension(100, 450));

        
        spPaneTableSup.setTopComponent(tabs);
        spPaneTableSup.setBottomComponent(tabw);
        spPaneTableSup.setPreferredSize(new Dimension(100, 200));
        tabs.setPreferredSize(new Dimension(100, 125));
        tabw.setPreferredSize(new Dimension(100, 125));
