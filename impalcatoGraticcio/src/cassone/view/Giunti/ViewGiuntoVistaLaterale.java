...
public class ViewGiuntoVistaLaterale extends JPanel {
...
//	private int B, H, b0, b, h,be1,be2;
     ...
     *
     */
    public ViewGiuntoVistaLaterale() {
        super();
        try {
            jbInit();
        } catch (Exception e) {
    ...
    public static JPanel getInstance() {
        ...
        if (container == null) {
            ...
            container.setBorder(new TitledBorder( new EtchedBorder(
                    EtchedBorder.LOWERED, Color.white, Color.gray), "VISTA LATERALE",0,0,fnt,Color.BLUE));
            
            container.setBackground(Color.BLACK);
            container.add( new ViewGiuntoVistaLaterale() );
