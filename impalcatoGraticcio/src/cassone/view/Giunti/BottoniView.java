...
public class BottoniView extends JPanel {
	...
	JButton jBAddGiunto = new JButton();
	JButton jBRemoveGiunto = new JButton();
	

	JPanel pButton = new JPanel();

	ControllerVerificaGiunti controller = new ControllerVerificaGiunti();
	...
	void jbInit() throws Exception {
		...
		jBAddGiunto.setFont(new java.awt.Font("SansSerif", 0, 13));
		jBAddGiunto.setPreferredSize(new Dimension(60, 25));
		jBAddGiunto.setActionCommand("ADD_GIUNTO");
		jBAddGiunto.setMargin(new Insets(0, 2, 2, 2));
		jBAddGiunto.setText("Aggiungi irrigidimento");
		
		jBRemoveGiunto.setFont(new java.awt.Font("SansSerif", 0, 13));
		jBRemoveGiunto.setPreferredSize(new Dimension(60, 25));
		jBRemoveGiunto.setActionCommand("REMOVE_GIUNTO");
		jBRemoveGiunto.setMargin(new Insets(0, 2, 2, 2));
		jBRemoveGiunto.setText("Elimina irrigidimento");
		...
		pButton.add(jBAddGiunto, null);
		pButton.add(jBRemoveGiunto, null);
...
//		pButton.add(btImportaCond, null);
		...
		jBAddGiunto.addActionListener(controller);
		jBRemoveGiunto.addActionListener(controller);
