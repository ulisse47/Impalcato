...
public class ViewGiuntoPiantaInferiore extends JPanel {
...
//	private int B, H, b0, b, h,be1,be2;
     ...
     *
     */
    public ViewGiuntoPiantaInferiore() {
        super();
        try {
            jbInit();
        } catch (Exception e) {
    ...
    public static JPanel getInstance() {
        ...
        if (container == null) {
            ...
            container.setBorder(new TitledBorder( new EtchedBorder(
                    EtchedBorder.LOWERED, Color.white, Color.gray), "PIANTA INFERIORE",0,0,fnt,Color.BLUE));
            container.setBackground(Color.BLACK);
            container.add( new ViewGiuntoPiantaInferiore() );
...
//        Htot = (int)(1.5*(Hcarp+bs+bi));
        ...
        xOrig = W / 2+originOffset[0];
        Yorig = H / 2+originOffset[1];;
...
/*
        //PIATTABANDA SUP
        setFattoreDiScala(g2d);
        at.setToTranslation(0,-Hfinestra/2+Hfinestra*(v1+v2/2)-bs/2-3*ddquote);
        g2d.transform(at);
        disegnaQuotaTraDuePunti(-bxs/2, -bxs/2 +e1asup, "", ddquote, g2d);
        disegnaQuotaTraDuePunti(bxs/2 -e1asup,bxs/2,  "", ddquote, g2d);
        dx=e1asup;
        ...
        //...quote verticali
        setFattoreDiScala(g2d);
        at.setToTranslation(-bxs/2-3*ddquote,-Hfinestra/2+Hfinestra*(v1+v2/2) + bys/2);
        g2d.transform(at);
        at.setToRotation(-3.14/2);
        g2d.transform(at);
 ...
 */
        //PIATTABANDA INF
        setFattoreDiScala(g2d);
        at.setToTranslation(0,-bi/2-3*ddquote);
        g2d.transform(at);
        disegnaQuotaTraDuePunti(-bxi/2, -bxi/2 +e1ainf, "", ddquote, g2d);
        disegnaQuotaTraDuePunti(bxi/2 -e1ainf,bxi/2,  "", ddquote, g2d);
        dx=e1ainf;
        ...
        //...quote verticali
        setFattoreDiScala(g2d);
        at.setToTranslation(-bxi/2-3*ddquote, + byi/2);
        g2d.transform(at);
        at.setToRotation(-3.14/2);
        g2d.transform(at);
