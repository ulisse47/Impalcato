...
public class TabTensioni
 ...
 //       BottoniView bottoni = BottoniView.getInstance();
        ...
        spCampateTensioni.setOrientation(JSplitPane.VERTICAL_SPLIT);

        //setta le dimensioni dei pannelli
        //inputPanel.setPreferredSize(new Dimension(200, 400));
        inputPanel.setMinimumSize( new Dimension(250,5) );
        //inputPanel.setMaximumSize(new Dimension(200, 500));
//        bottoni.setPreferredSize(new Dimension(700, 5));

 
        //tabella delle condizioni
        JScrollPane scPaneCond = TableCondView.getInstance();
        scPaneCond.setPreferredSize(new Dimension(380, 100));
        scPaneCond.setMinimumSize(new Dimension(380, 5));


        //tabella delle combinazioni
        JScrollPane scPaneComb = TableCombView.getInstance();
        scPaneComb.setPreferredSize(new Dimension(380, 50));
        scPaneComb.setMinimumSize(new Dimension(380, 5));
                            
        
        spPaneCenterBottom.setLeftComponent( scPaneCond );
        spPaneCenterBottom.setRightComponent( scPaneComb );
          
        campateV.setMinimumSize(new Dimension(380, 5));
        campateV.setPreferredSize(new Dimension(380, 100));
        
        tverifcaView.setMinimumSize(new Dimension(380, 5));
        tverifcaView.setPreferredSize(new Dimension(380, 300));
        
        spCampateTensioni.setLeftComponent(tverifcaView);
        spCampateTensioni.setRightComponent(campateV);
        tverifcaView.setPreferredSize(new Dimension(380, 150));
        campateV.setPreferredSize(new Dimension(380, 50));
        
        spPaneMain.setLeftComponent( /*spPaneLeft*/inputPanel );
        spPaneMain.setRightComponent( /*spPaneLeftBottom*/spCampateTensioni  );
        spPaneMain.setBackground(Color.black);
        spPaneMain.setPreferredSize(new Dimension(380, 320));
        ...
        split.setTopComponent(spPaneCenter);
        split.setBottomComponent(TableTensioniView.getInstance());
