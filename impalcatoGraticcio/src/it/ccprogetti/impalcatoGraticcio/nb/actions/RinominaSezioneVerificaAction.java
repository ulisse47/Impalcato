...
public final class RinominaSezioneVerificaAction extends CallableSystemAction {
    
    private ControllerVerificaSezioni controller = new ControllerVerificaSezioni();
    
    public void performAction() {
        controller.rinominaSezioni();
        TensioniAction.open();
    }
    
    
    public String getName() {
        return NbBundle.getMessage(RinominaSezioneVerificaAction.class, "CTL_RinominaSezioneVerificaAction");
    }
