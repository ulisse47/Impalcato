...
public final class DeleteCampataAction extends CallableSystemAction {
  
    private ControllerAnalisi controller = new ControllerAnalisi();
    
    public void performAction() {
        controller.rimuoviCampata();
        GeometriaAction.open();
    }
    
           
    public String getName() {
        return NbBundle.getMessage(DeleteCampataAction.class, "CTL_DeleteCampataAction");
    }
