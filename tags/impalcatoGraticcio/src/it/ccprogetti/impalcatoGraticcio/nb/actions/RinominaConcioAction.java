...
public final class RinominaConcioAction extends CallableSystemAction {
    
    private ControllerAnalisi controller = new ControllerAnalisi();
    
    public void performAction() {
       controller.rinominaConci();
        GeometriaAction.open();
    }
    
    public String getName() {
        return NbBundle.getMessage(RinominaConcioAction.class, "CTL_RinominaConcioAction");
    }
