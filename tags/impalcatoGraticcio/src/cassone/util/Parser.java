...
import cassone.model.IrrigidimentoTrasversale;
...
//				.isSelected());
    ...
    private static void validateVerificaSezioni() throws Exception {
        ...
        if (!inputPanel.getCkCalcoloAutomatico().isSelected()) {
            // sl.setB(Double.parseDouble(inputPanel.getValue("l1")));
     ...
     */
        /*
         * public static Object[][] getRowDataTensioniIdeali() { int cure_sez =
         * Common.current_sezione; // se le tensioni non sono ancora state calcolate
         * if (Common.tensioni_ideali == null) { return new Object[0][0]; } // se le
         * tensioni per la sezione corrente non sono ancora state // calcolate if
         * (cure_sez >= Common.tensioni_ideali.length) { return new Object[0][0]; }
         *
         * Object[][] data = new
         * Object[Common.tensioni_ideali[0].length][Common.tensioni_ideali[0][0].length +
         * 1];
         *
         * data[0][0] = "Sigma-c"; data[1][0] = "Sigma-a"; data[2][0] = "Sigma-3";
         * data[3][0] = "Sigma-i4"; data[4][0] = "Sigma-e4"; data[5][0] =
         * "Sigma-i5"; data[6][0] = "Sigma-e5"; data[7][0] = "Sigma-6"; data[8][0] =
         * "Sigma-im"; data[9][0] = "Sigma-em";
         *
         * for (int i = 0; i < data.length; i++) { for (int k = 1; k <=
         * Common.ncomb; k++) { data[i][k] = new Integer( (int)
         * Common.tensioni_ideali[cure_sez][i][k - 1]); } }
         *
         * return data; }
         */
